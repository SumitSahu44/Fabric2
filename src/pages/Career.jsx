    ...
    <div className="bg-[#FDFBF7] min-h-screen pt-40 pb-20 px-8">
      <div className="max-w-5xl mx-auto">
        <header className="mb-20">
          ...
          <h1 style={{ color: darkColor }} className="text-6xl font-light text-center uppercase tracking-tighter">
          ...
          {jobs.map((job, index) => (
            <div key={index} className="bg-white p-8 shadow-xl flex justify-between items-center border-l-4 border-transparent hover:border-[#C5A059] transition-all group">
              <div>
                ...
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">{job.location} • {job.type}</p>
              </div>
        ...
        <div className="mt-20 p-12 bg-textile-dark text-white text-center">
          ...
          <p className="text-gray-400 text-sm mb-8 uppercase tracking-widest">Send your CV to <span className="text-textile-gold">hr@parekhfabrics.com</span></p>
