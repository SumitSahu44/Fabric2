      ...
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/10 pb-16">
        ...
        <div className="col-span-1">
          ...
          <div className="mt-8 flex gap-4">
             {/* Social Circles */}
             <div style={{ border: '1px solid rgba(255,255,255,0.1)' }} className="w-8 h-8 rounded-full flex items-center justify-center text-[9px] hover:border-[#C5A059] cursor-pointer transition-all">FB</div>
             <div style={{ border: '1px solid rgba(255,255,255,0.1)' }} className="w-8 h-8 rounded-full flex items-center justify-center text-[9px] hover:border-[#C5A059] cursor-pointer transition-all">LI</div>
             <div style={{ border: '1px solid rgba(255,255,255,0.1)' }} className="w-8 h-8 rounded-full flex items-center justify-center text-[9px] hover:border-[#C5A059] cursor-pointer transition-all">IG</div>
          </div>
        </div>
        ...
        <div>
          ...
          <Link to="/tenders" className={linkStyle}>e-Auction Portal</Link>
          <Link to="/tenders" className={linkStyle}>Tender & Contract</Link>
        </div>
        ...
        <div>
          ...
          <Link to="/about" className={linkStyle}>Our Management</Link>
          <Link to="/career" className={linkStyle}>Careers</Link>
          <Link to="/contact" className={linkStyle}>Visit Appointment</Link>
        </div>
